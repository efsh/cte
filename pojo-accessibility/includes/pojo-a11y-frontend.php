...
final class Pojo_A11y_Frontend {
	...
	public function enqueue_scripts() {
		...
		wp_register_script(
			'cte',
			POJO_A11Y_ASSETS_URL . 'js/cte.js',
			array(
				'jquery',
			),
			'1.0.0',
		...
		wp_register_style(
			'cte',
			POJO_A11Y_ASSETS_URL . 'css/cte.css',
			array(),
			'1.0.0'
		);

		wp_enqueue_script( 'pojo-a11y' );
		wp_enqueue_script( 'cte' );
		wp_enqueue_style( 'pojo-a11y' );
		wp_enqueue_style( 'cte' );
				...
				<div class="pojo-a11y-toolbar-inner">
					...
					<ul class="pojo-a11y-toolbar-items pojo-a11y-tools">
						...
						<?php if ( $this->is_toolbar_button_active( 'VLibras' ) ) : ?>
							<li class="pojo-a11y-toolbar-item">
								<a href="#" class="pojo-a11y-toolbar-link pojo-a11y-btn-vlibras" data-action="vlibras" data-action-group="toggle" tabindex="-1">
									<?php echo $this->get_toolbar_button_title( 'VLibras' ); ?>
								</a>
							</li>
						<?php endif; ?>
					</ul>
	...
	private function get_toolbar_svg( $icon ) {
		...
		if ( false === $icons ) {
			$icons = array(
				...
				'VLibras' => '<path fill="currentColor" d="M384 224c0 105.75-86.25 192-192 192-57.25 0-111.25-25.25-147.75-69.25-2.5-3.25-2.25-8 0.5-10.75l34.25-34.5c1.75-1.5 4-2.25 6.25-2.25 2.25 0.25 4.5 1.25 5.75 3 24.5 31.75 61.25 49.75 101 49.75 70.5 0 128-57.5 128-128s-57.5-128-128-128c-32.75 0-63.75 12.5-87 34.25l34.25 34.5c4.75 4.5 6 11.5 3.5 17.25-2.5 6-8.25 10-14.75 10h-112c-8.75 0-16-7.25-16-16v-112c0-6.5 4-12.25 10-14.75 5.75-2.5 12.75-1.25 17.25 3.5l32.5 32.25c35.25-33.25 83-53 132.25-53 105.75 0 192 86.25 192 192z"></path>',
